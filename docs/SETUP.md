...
As microinterações da tela usam Framer Motion: entrada suave do formulário, surgimento escalonado dos métodos e rotação 3D curta no hover/press. O comportamento respeita `prefers-reduced-motion`.
