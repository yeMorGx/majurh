...
A página `/organizacao` funciona como um pequeno brand studio do tenant: hero de identidade, metadados do workspace, upload de arquivos, cores com função, textos do login, preview em moldura de navegador e acesso separado para convites. O preview atualiza enquanto o formulário é editado e mantém o princípio de mostrar a consequência antes de salvar.
