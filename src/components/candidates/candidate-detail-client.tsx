...
import { processStageDescriptions, processStatuses } from '@/lib/processes/constants';
import Link from 'next/link';
import { useEffect, useState } from 'react';

type Candidate = { id: string; full_name: string; cpf: string; rg: string | null; identity_document_type: 'rg' | 'cin'; birth_date: string | null; phone: string | null; email: string | null; city: string | null; state: string | null; street: string | null; address_number: string | null; notes: string | null; updated_at: string };
...
function formatDocumentType(value: string) { return ({ proof_of_address: 'Comprovante de residência', work_card: 'Carteira de trabalho', resume: 'Currículo', rg: 'RG', cin: 'CIN', certificate: 'Certificado' } as Record<string, string>)[value] ?? value.toUpperCase(); }
