...
async function findInvitation(token: string) {
  ...
  const rows = await db`
    select i.id, i.email, i.role, i.expires_at, i.accepted_at, i.organization_id,
      ...
      o.brand_logo_url, o.brand_primary_color, o.brand_accent_color,
      o.brand_login_banner_url, o.brand_login_kicker, o.brand_login_headline, o.brand_login_description
...
function toPublicInvitation(invite: InvitationRow) {
  return {
    ...
    organization: {
      ...
      brand_login_banner_url: invite.brand_login_banner_url,
